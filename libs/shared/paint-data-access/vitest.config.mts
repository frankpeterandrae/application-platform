...
export default defineConfig({
	root: __dirname,
	cacheDir: resolve(process.cwd(), 'node_modules/.vite/libs/shared/paint-data-access'),
	...
	test: {
		...
		outputFile: resolve(process.cwd(), 'test-result/libs/shared/paint-data-access/index.html'),
