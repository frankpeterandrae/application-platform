...
export default defineConfig({
	root: __dirname,
	cacheDir: resolve(process.cwd(), 'node_modules/.vite/libs/stream-overlay/dashboard'),
	...
	test: {
		...
		outputFile: resolve(process.cwd(), 'test-result/libs/stream-overlay/dashboard/index.html'),
