...
export default defineConfig({
	root: __dirname,
	cacheDir: resolve(process.cwd(), 'node_modules/.vite/libs/stream-overlay/paint-selector'),
	...
	test: {
		...
		outputFile: resolve(process.cwd(), 'test-result/libs/stream-overlay/paint-selector/index.html'),
